...
const main = async (): Promise<any> => {
  console.log(`validBase581 is ${bintools.isCB58(validBase581)}`)
  console.log(`validBase582 is ${bintools.isCB58(validBase582)}`)
  console.log(`invalidBase581 is ${bintools.isCB58(invalidBase581)}`)
  console.log(`invalidBase582 is ${bintools.isCB58(invalidBase582)}`)
}
