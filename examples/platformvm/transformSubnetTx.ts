...
const main = async (): Promise<any> => {
  ...
  const maxConsumptionRate: BN = new BN(10)
  const minValidatorStake: BN = new BN(10)
  const maxValidatorStake: BN = new BN(100)
  ...
  transformSubnetTx.addSignatureIdx(0, pAddresses[3])
  transformSubnetTx.addSignatureIdx(1, pAddresses[1])
  const unsignedTx: UnsignedTx = new UnsignedTx(transformSubnetTx)
