...
export class AdminAPI extends JRPCAPI {
  ...
  */
  getChainAliases = async (chain: string): Promise<string[]> => {
    ...
    const response: RequestResponseData = await this.callMethod("admin.getChainAliases", params)
  ...
  */
  lockProfile = async (): Promise<boolean> => {
    const response: RequestResponseData = await this.callMethod("admin.lockProfile")
    return response.data.result.success
  }
  ...
  */
  memoryProfile = async (): Promise<boolean> => {
    const response: RequestResponseData = await this.callMethod("admin.memoryProfile")
    return response.data.result.success
  }
  ...
  */
  startCPUProfiler = async (): Promise<boolean> => {
    const response: RequestResponseData = await this.callMethod("admin.startCPUProfiler")
    return response.data.result.success
  }
