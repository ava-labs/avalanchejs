...
export class AuthAPI extends JRPCAPI {
     ...
     *
     * @returns Returns a Promise<bool> indicating if a token was successfully revoked.
     */
     ...
     *
     * @returns Returns a Promise<bool> indicating if the password was successfully changed.
     */
