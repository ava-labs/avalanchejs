...
export class OutputOwners extends Serializable {
  ...
  serialize(encoding:SerializedEncoding = "hex"):object {
    ...
    return {
      ...fields,
      "locktime": serialization.encoder(this.locktime, encoding, "Buffer", "decimalString", 8),
      "threshold": serialization.encoder(this.threshold, encoding, "Buffer", "decimalString", 4),
      "addresses": this.addresses.map((a: Address): object => a.serialize(encoding))
    }
  }
