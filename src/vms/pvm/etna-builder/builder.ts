...
type CommonTxProps = Readonly<{
  ...
  changeOwnerLocktime?: bigint;
  /**
   * Optional. The most AVAX, in nAVAX, this transaction may burn as its fee.
   *
   * The fee is `gas * feeState.price`, computed entirely from values the RPC
   * node reported. That node also serves your UTXOs, so it knows your balance;
   * without a ceiling it decides how much of it is destroyed. Set this to a
   * figure you are willing to pay and the builder throws instead.
   *
