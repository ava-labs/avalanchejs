...
describe('Outputs', () => {
    describe('NFTMintOutput', () => {
      ...
      test('SelectOutputClass', () => {
          let goodout:NFTMintOutput = new NFTMintOutput(0, 1, addrpay);
      ...
      test('comparator', () => {
          let outpayment1:Output = new NFTMintOutput(1, 1, addrs);
          let outpayment2:Output = new NFTMintOutput(2, 1, addrs);
          let outpayment3:Output = new NFTMintOutput(0, 1, addrs);
      ...
      test('Functionality', () => {
          let out:NFTMintOutput = new NFTMintOutput(0, 3, addrs);
