...
describe('Inputs', (): void => {
  ...
  test('EVMInput comparator', (): void => {
    ...
    const assetID2: string =
      'vvKCjrpggyQ8FhJ2D5EAKPh8x8y4JK93JQiWRpTKpEouydRbG'; // 7a6e1e3c9c66ed8f076180f89d01320795628dca633001ff437ac6ab58b455be
    const assetID3: string =
      'eRo1eb2Yxd87KuMYANBSha3n138wtqRhFz2xjftsXWnmpCxyh'; // 54fbd087a8a9c739c2c7926d742ea7b937adbd512b9ff0fd51f460a763d1371a
    ...
    const assetID6: string =
      'ZWXaLcAy1YWS3Vvjcrt2KcVA4VxBsMFt8yNDZABJkgBvgpRti'; // 49d0dc67846a20dfea79b7beeba84769efa4a0273575f65ca79f9dee1cd1250e
    const assetID7: string =
      'FHfS61NfF5XdZU62bcXp9yRfgrZeiQC7VNJWKcpdb9QMLHs4L'; // 2070e77e34941439dc7bcf502dcf555c6ef0e3cc46bbac8a03b22e15c84a81f1
    const assetID8: string =
      'ZL6NeWgcnxR2zhhKDx7h9Kg2mZgScC5N4RG5FCDayWY7W3whZ'; // 496849239bb1541e97fa8f89256965bf7e657f3bb530cad820dd41706c5e3836
