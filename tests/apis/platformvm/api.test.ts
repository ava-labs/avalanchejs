...
describe('PlatformVMAPI', () => {
  ...
  test('getUTXOs', async () => {
    ...
    let result:Promise<UTXOSet> = api.getUTXOs(addresses, api.getBlockchainID(), 0, 1, undefined, persistOpts);
    const payload:object = {
      result: {
    ...
    result = api.getUTXOs(addresses, api.getBlockchainID(), 0, 0, undefined, persistOpts);
