  ...
  describe('serialize && deserialize', (): void => {
    ...
    describe('AVM', (): void => {
      ...
      test('GenesisAsset', (): void => {
        ...
        const symbolHex: string = serialization.encoder(
          symbol,
          hex,
          utf8,
          utf8
      ...
      test('OperationTx', (): void => {
        ...
        expect(serialization.bufferToType(operationtx2.getMemo(), cb58)).toBe(
          m
        );
      ...
      test('SECPTransferInput', (): void => {
        ...
        expect(secptransferinput2.toString()).toBe(
          secptransferinput.toString()
        );
      });
      ...
      test('SECPMintOperation', (): void => {
        ...
        expect(secpmintoperation2.toString()).toBe(
          secpmintoperation.toString()
        );
      });
      ...
      test('NFTTransferOperation', (): void => {
        ...
        expect(nfttransferoperation2.getTypeName()).toBe(
          'NFTTransferOperation'
        );
      ...
      test('TransferableOutput', (): void => {
        ...
        const transferableoutput2: TransferableOutput =
      ...
      test('SECPTransferOutput', (): void => {
        const secptransferoutput: SECPTransferOutput = new SECPTransferOutput();
        const secptransferoutput2: SECPTransferOutput =
      ...
      test('NFTTransferOutput', (): void => {
        ...
        expect(nfttransferoutput2.toString()).toBe(
          nfttransferoutput.toString()
        );
      });
